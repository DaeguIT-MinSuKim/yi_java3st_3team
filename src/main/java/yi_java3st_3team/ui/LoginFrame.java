...
public class LoginFrame extends JFrame {
	...
	public void setItem(Recommendation recom) {
		lblCategoryCon.setText(String.format("%s / %s", recom.getBookCode().getLcNo().getLclasName(), recom.getBookCode().getMlNo().getMlsfcName()));
		...
		if(recom.getBookCode().getTrnslrName().equals("")) {
			...
			lblWriterCon.setText(String.format("%s / %s", recom.getBookCode().getAuthrName(), recom.getBookCode().getTrnslrName()));
		}
	...
	private void setPicBookImg(byte[] bookImg, Dimension picDimension) {
		lblRecomImg.setIcon(new ImageIcon(new ImageIcon(bookImg).getImage().getScaledInstance((int)picDimension.getWidth(), 
