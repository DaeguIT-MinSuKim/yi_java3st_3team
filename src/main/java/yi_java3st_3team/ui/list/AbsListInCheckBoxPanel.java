...
import yi_java3st_3team.ui.list.AbsListInCheckBoxPanel.TableCell;

@SuppressWarnings("serial")
public abstract class AbsListInCheckBoxPanel<T> extends JPanel {
	private JScrollPane scrollPane;
	protected JTable table;
	protected DefaultTableModel model;
	protected List<T> list;

	public AbsListInCheckBoxPanel() {
		initialize();
	}
	...
	public void loadData(List<T> items) {
		list = items;
		model = new DefaultTableModel(getRows(items), getColNames());
	...
	protected class TableCell extends AbstractCellEditor implements TableCellEditor, TableCellRenderer {
