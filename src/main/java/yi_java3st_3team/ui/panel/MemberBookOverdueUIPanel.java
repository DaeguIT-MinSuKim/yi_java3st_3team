	...
	protected void btnSendMailActionPerformed(ActionEvent e) throws ParseException {
		...
		for(int i=0;i<model.getRowCount();i++) {
			if((boolean)model.getValueAt(i, 5)) {
				...
				Date now = new Date();
				String returnString = (String) (model.getValueAt(i, 3));
				...
				Date lendDate = sdf2.parse((String)(model.getValueAt(i, 2)));
				String lendStr = new SimpleDateFormat("yyyy년 MM월 dd일").format(lendDate);
				
				//메일로 보낼 반납예정일
				Date returnDate = sdf2.parse((String)(model.getValueAt(i, 3)));
				...
				String title = " [ " + (String)model.getValueAt(i, 1) + "님 대구도서관 도서 연체 메일 ] ";
				
				message.append(" [ 대구도서관에서 안내 드립니다 ]" +System.getProperty("line.separator"));
				message.append(System.getProperty("line.separator"));
				message.append((String)model.getValueAt(i, 1) + "님께서 대출중인 도서가 " + resultDay + "일 연체 중에 있습니다." + System.getProperty("line.separator"));
				...
				message.append(System.getProperty("line.separator"));
				message.append("1)도서 대출일 : " + lendStr + System.getProperty("line.separator"));
				message.append("2)반납 예정일 : " + returnStr + System.getProperty("line.separator"));
				message.append("3)대출 도서권수 : " + model.getValueAt(i, 4) +"권"+ System.getProperty("line.separator"));
				message.append(System.getProperty("line.separator"));
